...
import net.openchrom.wsd.converter.supplier.cdf.io.ChromatogramReaderWSD;

public class ChromatogramImportConverterWSD extends AbstractChromatogramImportConverter<IChromatogramWSD> {

	private static final Logger logger = Logger.getLogger(ChromatogramImportConverterWSD.class);
