 ...
 *******************************************************************************/
package net.openchrom.msd.converter.supplier.microbems.pkf.converter.io;
...
import net.openchrom.msd.converter.supplier.microbems.pkf.converter.model.PeakListFileMassSpectrum;
...
public class PkfReader extends AbstractMassSpectraReader {
	...
	public IMassSpectra read(File file, IProgressMonitor monitor) throws IOException {
		...
		for(int col = 0; col < c.getNumCols(); col++) {
			...
			PeakListFileMassSpectrum pkf = new PeakListFileMassSpectrum();
