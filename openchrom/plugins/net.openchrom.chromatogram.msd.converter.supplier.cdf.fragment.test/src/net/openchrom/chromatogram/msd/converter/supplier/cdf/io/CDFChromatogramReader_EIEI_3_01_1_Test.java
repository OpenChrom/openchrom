 ...
 * @author eselmeister
 */
public class CDFChromatogramReader_EIEI_3_01_1_Test extends CDFChromatogramReaderTestCase {
	...
	public void testCDFChromatogramReader_1() {
		...
		assertEquals("numberOfScanMassFragments", 537595, chromatogram.getNumberOfScanMassFragments());
