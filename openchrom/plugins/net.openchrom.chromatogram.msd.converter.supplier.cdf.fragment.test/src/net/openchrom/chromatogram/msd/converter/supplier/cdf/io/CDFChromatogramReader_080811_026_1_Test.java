 ...
 * @author eselmeister
 */
public class CDFChromatogramReader_080811_026_1_Test extends CDFChromatogramReaderTestCase {
	...
	public void testCDFChromatogramReader_1() {
		...
		assertEquals("numberOfScanMassFragments", 389148, chromatogram.getNumberOfScanMassFragments());
