...
public class PeakDetectorDirectSettings extends AbstractPeakDetectorSettingsMSD implements IPeakDetectorSettingsCSD, IPeakDetectorSettingsWSD, ITemplateSettings {
	...
	@JsonPropertyDescription(value = "If true, ranges will be created using the existing peaks.")
