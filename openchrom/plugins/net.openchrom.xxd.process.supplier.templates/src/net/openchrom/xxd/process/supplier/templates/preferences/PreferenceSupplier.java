...
public class PreferenceSupplier extends AbstractPreferenceSupplier implements IPreferenceSupplier {
	...
	public void initializeDefaults() {
		...
		putDefault(P_COMPENSATION_QUANTIFIER_LIST, DEF_COMPENSATION_QUANTIFIER_LIST);
		putDefault(P_CHROMATOGRAM_REPORT_LIST, DEF_CHROMATOGRAM_REPORT_LIST);
		putDefault(P_CHROMATOGRAM_REVIEW_LIST_MSD, DEF_CHROMATOGRAM_REVIEW_LIST_MSD);
		putDefault(P_CHROMATOGRAM_REVIEW_LIST_CSD, DEF_CHROMATOGRAM_REVIEW_LIST_CSD);

		putDefault(P_LIST_PATH_IMPORT, DEF_LIST_PATH_IMPORT);
		putDefault(P_LIST_PATH_EXPORT, DEF_LIST_PATH_EXPORT);

		putDefault(P_OFFSET_MIN_Y, Integer.toString(DEF_OFFSET_MIN_Y));
		putDefault(P_OFFSET_MAX_Y, Integer.toString(DEF_OFFSET_MAX_Y));

		putDefault(P_SORT_IMPORT_TEMPLATE, Boolean.toString(DEF_SORT_IMPORT_TEMPLATE));
		putDefault(P_SORT_EXPORT_TEMPLATE, Boolean.toString(DEF_SORT_EXPORT_TEMPLATE));
		putDefault(P_DETECTOR_SETTINGS_SORT, Boolean.toString(DEF_DETECTOR_SETTINGS_SORT));
		putDefault(P_REVIEW_SETTINGS_SORT, Boolean.toString(DEF_REVIEW_SETTINGS_SORT));
		putDefault(P_REPORT_SETTINGS_SORT, Boolean.toString(DEF_REPORT_SETTINGS_SORT));

		putDefault(P_EXPORT_NUMBER_TRACES_DETECTOR, Integer.toString(DEF_EXPORT_NUMBER_TRACES_DETECTOR));
		putDefault(P_EXPORT_OPTIMIZE_RANGE_DETECTOR, Boolean.toString(DEF_EXPORT_OPTIMIZE_RANGE_DETECTOR));
		putDefault(P_EXPORT_DELTA_LEFT_POSITION_DETECTOR, Double.toString(DEF_EXPORT_DELTA_LEFT_POSITION_DETECTOR));
		...
		putDefault(P_EXPORT_NUMBER_TRACES_REVIEW, Integer.toString(DEF_EXPORT_NUMBER_TRACES_REVIEW));
		putDefault(P_EXPORT_OPTIMIZE_RANGE_REVIEW, Boolean.toString(DEF_EXPORT_OPTIMIZE_RANGE_REVIEW));
		putDefault(P_EXPORT_DELTA_LEFT_MILLISECONDS_REVIEW, Integer.toString(DEF_EXPORT_DELTA_LEFT_MILLISECONDS_REVIEW));
		putDefault(P_EXPORT_DELTA_RIGHT_MILLISECONDS_REVIEW, Integer.toString(DEF_EXPORT_DELTA_RIGHT_MILLISECONDS_REVIEW));

		putDefault(P_EXPORT_NUMBER_TRACES_ASSIGNER, Integer.toString(DEF_EXPORT_NUMBER_TRACES_ASSIGNER));
		putDefault(P_EXPORT_DELTA_LEFT_MILLISECONDS_ASSIGNER, Integer.toString(DEF_EXPORT_DELTA_LEFT_MILLISECONDS_ASSIGNER));
		putDefault(P_EXPORT_DELTA_RIGHT_MILLISECONDS_ASSIGNER, Integer.toString(DEF_EXPORT_DELTA_RIGHT_MILLISECONDS_ASSIGNER));

		putDefault(P_EXPORT_DELTA_LEFT_MILLISECONDS_STANDARDS, Integer.toString(DEF_EXPORT_DELTA_LEFT_MILLISECONDS_STANDARDS));
		putDefault(P_EXPORT_DELTA_RIGHT_MILLISECONDS_STANDARDS, Integer.toString(DEF_EXPORT_DELTA_RIGHT_MILLISECONDS_STANDARDS));

		putDefault(P_EXPORT_DELTA_LEFT_MILLISECONDS_REPORT, Double.toString(DEF_EXPORT_DELTA_LEFT_MILLISECONDS_REPORT));
		 ...
		 * Transfer
		 */
		putDefault(P_TRANSFER_USE_IDENTIFIED_PEAKS_ONLY, Boolean.toString(DEF_TRANSFER_USE_IDENTIFIED_PEAKS_ONLY));
		putDefault(P_TRANSFER_USE_BEST_TARGET_ONLY, Boolean.toString(DEF_TRANSFER_USE_BEST_TARGET_ONLY));
		putDefault(P_TRANSFER_MATCH_QUALITY, Float.toString(DEF_TRANSFER_MATCH_QUALITY));
		putDefault(P_TRANSFER_RETENTION_TIME_MILLISECONDS_LEFT, Integer.toString(DEF_TRANSFER_RETENTION_TIME_MILLISECONDS_LEFT));
		putDefault(P_TRANSFER_RETENTION_TIME_MILLISECONDS_RIGHT, Integer.toString(DEF_TRANSFER_RETENTION_TIME_MILLISECONDS_RIGHT));
		putDefault(P_TRANSFER_OFFSET_RETENTION_TIME_MILLISECONDS_PEAK_MAXIMUM, Integer.toString(DEF_TRANSFER_OFFSET_RETENTION_TIME_MILLISECONDS_PEAK_MAXIMUM));
		putDefault(P_TRANSFER_ADJUST_PEAK_HEIGHT, Boolean.toString(DEF_TRANSFER_ADJUST_PEAK_HEIGHT));
		putDefault(P_TRANSFER_CREATE_MODEL_PEAK, Boolean.toString(DEF_TRANSFER_CREATE_MODEL_PEAK));
		putDefault(P_TRANSFER_PEAK_OVERLAP_COVERAGE, Double.toString(DEF_TRANSFER_PEAK_OVERLAP_COVERAGE));
		putDefault(P_TRANSFER_OPTIMIZE_RANGE, Boolean.toString(DEF_TRANSFER_OPTIMIZE_RANGE));
		putDefault(P_TRANSFER_CHECK_PURITY, Boolean.toString(DEF_TRANSFER_CHECK_PURITY));
		putDefault(P_TRANSFER_NUMBER_TRACES, Integer.toString(DEF_TRANSFER_NUMBER_TRACES));

		putDefault(P_REPORT_REFERENCED_CHROMATOGRAMS, Boolean.toString(DEF_REPORT_REFERENCED_CHROMATOGRAMS));
		/*
		 * Detector
		 */
		putDefault(P_DETECTOR_DELTA_LEFT_MILLISECONDS, Integer.toString(DEF_DETECTOR_DELTA_LEFT_MILLISECONDS));
		putDefault(P_DETECTOR_DELTA_RIGHT_MILLISECONDS, Integer.toString(DEF_DETECTOR_DELTA_RIGHT_MILLISECONDS));
		putDefault(P_DETECTOR_DYNAMIC_OFFSET_MILLISECONDS, Integer.toString(DEF_DETECTOR_DYNAMIC_OFFSET_MILLISECONDS));
		putDefault(P_DETECTOR_REPLACE_NEAREST_PEAK, Boolean.toString(DEF_DETECTOR_REPLACE_NEAREST_PEAK));
		putDefault(P_DETECTOR_REPLACE_PEAK_DELTA_MILLISECONDS, Integer.toString(DEF_DETECTOR_REPLACE_PEAK_DELTA_MILLISECONDS));
		putDefault(P_DETECTOR_HIDE_EXISTING_PEAKS, Boolean.toString(DEF_DETECTOR_HIDE_EXISTING_PEAKS));
		putDefault(P_DETECTOR_VISIBILITY, DEF_DETECTOR_VISIBILITY);
		 ...
		 * Review
		 */
		putDefault(P_REVIEW_DELTA_LEFT_MILLISECONDS, Integer.toString(DEF_REVIEW_DELTA_LEFT_MILLISECONDS));
		putDefault(P_REVIEW_DELTA_RIGHT_MILLISECONDS, Integer.toString(DEF_REVIEW_DELTA_RIGHT_MILLISECONDS));
		putDefault(P_REVIEW_DYNAMIC_OFFSET_MILLISECONDS, Integer.toString(DEF_REVIEW_DYNAMIC_OFFSET_MILLISECONDS));
		putDefault(P_REVIEW_REPLACE_NEAREST_PEAK, Boolean.toString(DEF_REVIEW_REPLACE_NEAREST_PEAK));
		putDefault(P_REVIEW_REPLACE_PEAK_DELTA_MILLISECONDS, Integer.toString(DEF_REVIEW_REPLACE_PEAK_DELTA_MILLISECONDS));
		putDefault(P_REVIEW_SET_TARGET_VERIFICATION, Boolean.toString(DEF_REVIEW_SET_TARGET_VERIFICATION));
		putDefault(P_REVIEW_AUTO_SELECT_BEST_MATCH, Boolean.toString(DEF_REVIEW_AUTO_SELECT_BEST_MATCH));
		putDefault(P_REVIEW_HIDE_EXISTING_PEAKS, Boolean.toString(DEF_REVIEW_HIDE_EXISTING_PEAKS));
		putDefault(P_REVIEW_SET_TARGET_DETECTED_PEAK, Boolean.toString(DEF_REVIEW_SET_TARGET_DETECTED_PEAK));
		putDefault(P_REVIEW_VISIBILITY, DEF_REVIEW_VISIBILITY);
		putDefault(P_REVIEW_FOCUS_XIC, Boolean.toString(DEF_REVIEW_FOCUS_XIC));
		putDefault(P_REVIEW_SHOW_BASELINE, Boolean.toString(DEF_REVIEW_SHOW_BASELINE));
		putDefault(P_REVIEW_SHOW_DETAILS, Boolean.toString(DEF_REVIEW_SHOW_DETAILS));
		putDefault(P_REVIEW_UPDATE_SEARCH_TARGET, Boolean.toString(DEF_REVIEW_UPDATE_SEARCH_TARGET));
	...
	public static boolean isAutoAdjustDetectorRange() {
		...
		return INSTANCE().getBoolean(P_AUTO_ADJUST_DETECTOR_RANGE, DEF_AUTO_ADJUST_DETECTOR_RANGE);
	}
