 ...
 * 
 * <p>
 * In contrast to {@link RangeIntegerDummy}, an {@code AbstractIntegerRange} is immutable and also provides basic value checking e.g. {@code start <= stop}.
 * </p>
...
public abstract class RangeIntegerAbstract extends VeryAbstractIntegerRange implements RangeInteger {
	 ...
	 * @param limit1
	 *            minimum value that is valid for this {@code AbstractIntegerRange}'s start point
	 * @param limit2
	 *            maximum value that is valid for this {@code AbstractIntegerRange}'s stop point
	 ...
	 * @throws RangeException
	 */
	protected abstract RangeIntegerAbstract newInstange(int start, int stop, int limit1, int limit2) throws RangeException;

	public RangeInteger shift(final int offset) throws RangeException {

		return newInstange(ArithmeticSavety.addInt(getStart(), offset), ArithmeticSavety.addInt(getStop(), offset), getLimit1(), getLimit2());
	}
}
