...
public class UtilsRangeInteger {
	 ...
	 */
	public static <T extends RangeInteger> T merge(final List<? extends RangeInteger> ranges, final IntegerRangeFactory<T> factory) {
	...
	public static Map<Integer, Integer> positionFrequencies(final List<? extends RangeInteger> ranges, final List<? extends RangeInteger> ranges2) {
	...
	public static double medianPositionFrequencies(final List<? extends RangeInteger> ranges, final List<? extends RangeInteger> ranges2) {
	...
	public static <R extends RangeInteger> R trimmValidStart(final R range, final int minStart, final int maxStart, final IntegerRangeFactory<R> factory) {

		final int start = trimToBounds(range.getStart(), minStart, maxStart);
		return factory.create(start, range.getStop());
	}

	public static <R extends RangeInteger> R trimmValidStop(final R range, final int minStop, final int maxStop, final IntegerRangeFactory<R> factory) {

		final int stop = trimToBounds(range.getStop(), minStop, maxStop);
		return factory.create(range.getStart(), stop);
	}

	public static <R extends RangeInteger> R trimmValid(final R range, final int minStart, final int maxStop, final IntegerRangeFactory<? extends R> factory) {
