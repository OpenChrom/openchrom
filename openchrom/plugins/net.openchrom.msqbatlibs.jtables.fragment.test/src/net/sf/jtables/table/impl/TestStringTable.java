...
public class TestStringTable {
	...
	public final void testAddColumn01() throws IOException {
		...
		table1 = new ReaderTableString(new StringReader("rowIDs\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b"), true, true).readTableAtOnce();
	...
	public final void testAddColumn02() throws IOException {
		...
		table1 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "a.a\ta.b"), true, false).readTableAtOnce();
		// add another column to table
	...
	public final void testAddRow01() throws IOException {
		...
		// read a table from a string
		// table has row and column headers
		table1 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b"), true, true).readTableAtOnce();
		System.out.println("col-ident: " + table1.getColumnIdentifier());
		System.out.println("row-ident: " + table1.getRowIdentifier());
		System.out.println("rows: " + table1.getRows());
		System.out.println("cols: " + table1.getColumns());
	...
	public final void testEqualsObject02() throws IOException {
		...
		table1 = new ReaderTableString(new StringReader("rowIDs\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b" + UtilIO.NEW_LINE_STRING + "rowB\tb.a\tb.b"), true, true).readTableAtOnce();
		table2 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b" + UtilIO.NEW_LINE_STRING + "rowB\tb.a\tb.b"), true, true).readTableAtOnce();
		assertEquals(table1, table2);
	}
	...
	public final void testGetColumnObject01() throws IOException {
		...
		table1 = new ReaderTableString(new File("src/test/resources/anno-orphan-anno.txt"), true, false).readTableAtOnce();
	...
	public final void testGetColumns01() throws IOException {
		...
		table1 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b"), true, true).readTableAtOnce();
		assertArrayEquals(new ColumnImpl[]{new ColumnImpl<String>(Arrays.asList("a.a")), new ColumnImpl<String>(Arrays.asList("a.b"))}, table1.getColumns().toArray());
	}
	...
	public final void testHashCode02() throws IOException {
		...
		table1 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b" + UtilIO.NEW_LINE_STRING + "rowB\tb.a\tb.b"), true, true).readTableAtOnce();
		table2 = new ReaderTableString(new StringReader("\tcolA\tcolB" + UtilIO.NEW_LINE_STRING + "rowA\ta.a\ta.b" + UtilIO.NEW_LINE_STRING + "rowB\tb.a\tb.b"), true, true).readTableAtOnce();
		assertEquals(table1.hashCode(), table2.hashCode());
	}
