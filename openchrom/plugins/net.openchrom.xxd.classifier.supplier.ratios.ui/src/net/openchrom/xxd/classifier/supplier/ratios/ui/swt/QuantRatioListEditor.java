...
import net.openchrom.xxd.classifier.supplier.ratios.ui.internal.provider.quant.QuantRatioInputValidator;
import net.openchrom.xxd.classifier.supplier.ratios.util.quant.QuantRatioListUtil;

public class QuantRatioListEditor implements SettingsUIProvider.SettingsUIControl, IExtendedPartUI {
	...
	public String getSettings() throws IOException {
		...
		if(preferences != null) {
			QuantRatioSettings settingz = new QuantRatioSettings();
	...
	private void createTableSection(Composite parent) {
		...
		QuantRatioListUI quantRatioListUI = new QuantRatioListUI(parent, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
		Table table = quantRatioListUI.getTable();
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(IDialogConstants.OK_ID == dialog.open()) {
					...
					QuantRatio setting = settings.extractSettingInstance(item);
					if(setting != null) {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(object instanceof QuantRatio) {
					...
					if(IDialogConstants.OK_ID == dialog.open()) {
						String item = dialog.getValue();
						QuantRatio settingNew = settings.extractSettingInstance(item);
