...
import net.openchrom.xxd.classifier.supplier.ratios.core.QualRatioClassifier;
import net.openchrom.xxd.classifier.supplier.ratios.ui.runnables.ClassifierEvaluator;

public class ClassifierHandlerQual implements EventHandler {

	private static final Logger logger = Logger.getLogger(ClassifierHandlerQual.class);
	private static final String DESCRIPTION = "Quality Ratio Classifier";
	//
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			 ...
			 */
			IRunnableWithProgress runnable = new ClassifierEvaluator(chromatogramSelection, DESCRIPTION, QualRatioClassifier.CLASSIFIER_ID);
