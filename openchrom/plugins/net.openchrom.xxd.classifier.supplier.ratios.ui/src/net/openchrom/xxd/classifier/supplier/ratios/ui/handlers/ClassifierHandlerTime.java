...
import net.openchrom.xxd.classifier.supplier.ratios.core.TimeRatioClassifier;
import net.openchrom.xxd.classifier.supplier.ratios.ui.runnables.ClassifierEvaluator;

public class ClassifierHandlerTime implements EventHandler {

	private static final Logger logger = Logger.getLogger(ClassifierHandlerTime.class);
	private static final String DESCRIPTION = "Time Ratio Classifier";
	//
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			 ...
			 */
			IRunnableWithProgress runnable = new ClassifierEvaluator(chromatogramSelection, DESCRIPTION, TimeRatioClassifier.CLASSIFIER_ID);
