...
public class QuantRatioFieldEditor extends AbstractFieldEditor {

	private static final int NUMBER_COLUMNS = 2;
	//
	private Composite composite;
	private QuantRatios settings = new QuantRatios();
	private QuantRatioListUI listUI;
	//
	...
	public QuantRatioFieldEditor(String name, String labelText, Composite parent) {
		init(name, labelText);
	...
	private void createTableSection(Composite parent) {
		...
		composite.setLayoutData(gridData);
		//
		listUI = new QuantRatioListUI(composite, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
		//
