...
public class ClassifierHandlerTrace implements EventHandler {

	private static final Logger logger = Logger.getLogger(ClassifierHandlerTrace.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			 ...
			 */
			IRunnableWithProgress runnable = new ClassifierEvaluator(chromatogramSelection, DESCRIPTION, TraceRatioClassifier.CLASSIFIER_ID);
