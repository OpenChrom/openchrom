...
public class TimeRatioColorProvider implements ICellColorProvider {
	...
	public void setCellColor(ExtendedTableViewer tableViewer) {
		...
		TableViewerColumn tableViewerColumn = tableViewer.getTableViewerColumn(TimeRatioResultTitles.DEVIATION);
			...
			tableViewerColumn.setLabelProvider(new StyledCellLabelProvider() {
				...
				public void update(ViewerCell cell) {
					...
					if(cell != null) {
						...
						double deviation = timeRatio.getDeviation();
						double deviationWarn = timeRatio.getDeviationWarn();
						double deviationError = timeRatio.getDeviationError();
						//
