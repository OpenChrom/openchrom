...
public class TimeRatioSelectionListener extends SelectionAdapter implements SelectionListener {
	...
	public void widgetSelected(SelectionEvent e) {
		...
		if(object instanceof Table) {
			...
			if(data instanceof TimeRatio) {
				TimeRatio timeRatio = (TimeRatio)data;
