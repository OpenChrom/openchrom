...
import net.openchrom.xxd.classifier.supplier.ratios.core.QuantRatioClassifier;
import net.openchrom.xxd.classifier.supplier.ratios.ui.runnables.ClassifierEvaluator;

public class ClassifierHandlerQuant implements EventHandler {

	private static final Logger logger = Logger.getLogger(ClassifierHandlerQuant.class);
	private static final String DESCRIPTION = "Quant Ratio Classifier";
	//
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start " + DESCRIPTION);
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			IRunnableWithProgress runnable = new ClassifierEvaluator(chromatogramSelection, DESCRIPTION, QuantRatioClassifier.CLASSIFIER_ID);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, DESCRIPTION + " finished");
		}
	}
