...
public class TimeRatioValidator extends ValueParserSupport implements IValidator {
	...
	//
	private String name = "";
	private double expectedRetentionTime = 0.0d;
			...
			if(value instanceof String) {
				...
				if(text.contains(SEPARATOR_TOKEN)) {
					...
					if(values.length >= 4) {
						...
						//
						expectedRetentionTime = parseDouble(values, 1);
						if(expectedRetentionTime <= 0.0d) {
