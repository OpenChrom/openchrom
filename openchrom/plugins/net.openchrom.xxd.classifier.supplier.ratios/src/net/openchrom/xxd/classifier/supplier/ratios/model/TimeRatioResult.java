...
public class TimeRatioResult extends AbstractChromatogramClassifierResult implements IChromatogramClassifierResult {
	...
	private TimeRatios timeRatios;

	public TimeRatioResult(ResultStatus resultStatus, String description, TimeRatios timeRatios) {
		super(resultStatus, description);
		this.timeRatios = timeRatios;
	}

	public TimeRatios getTimeRatios() {
