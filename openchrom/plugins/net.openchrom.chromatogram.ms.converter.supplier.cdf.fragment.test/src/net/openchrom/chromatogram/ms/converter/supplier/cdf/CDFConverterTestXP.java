...
import net.openchrom.chromatogram.ms.converter.exceptions.FileIsNotWriteableException;
import net.openchrom.chromatogram.ms.converter.exceptions.NoChromatogramConverterAvailableException;
...
public class CDFConverterTestXP extends TestCase {
	...
	private final static String EXTENSION_POINT_ID = "net.openchrom.chromatogram.ms.converter.supplier.cdf";

	// private final static String EXTENSION_POINT_EXPORT_ID =
	// "net.openchrom.chromatogram.ms.supplier.agilent";
	@Override
