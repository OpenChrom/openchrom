...
public class CDFConverterTestX extends TestCase {
	...
	private final static String EXTENSION_POINT_CDF_ID = "net.openchrom.chromatogram.ms.converter.supplier.cdf";
	private final static String EXTENSION_POINT_AGILENT_ID = "net.openchrom.chromatogram.ms.converter.supplier.agilent";
