...
@XmlType(name = "AcquisitionParameterSet1DType", propOrder = {"directDimensionParameterSet"})
public class AcquisitionParameterSet1DType extends AcquisitionParameterSetType {
