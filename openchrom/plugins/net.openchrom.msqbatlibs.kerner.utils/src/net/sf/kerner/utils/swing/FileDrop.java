...
public class FileDrop {
	...
	/**
	 * This is the event that is passed to the {@link FileDropListener#filesDropped filesDropped(...)} method in your {@link FileDropListener} when files are dropped onto a registered drop
	 * target.
	 *
	 * <p>
	 * I'm releasing this code into the Public Domain. Enjoy.
	 ...
	 * dropping in your Java programs! When you need to create a {@link java.awt.datatransfer.Transferable} object, use this class to wrap
	 ...
	 * you're moving data out of a list, say, you can use the {@link TransferableObject.Fetcher} inner class to return your object Just
	 * in Time. For example:
	 *
	 * <pre>
	 * <code>
	 ...
	 * </pre>
	 *
	 * The {@link java.awt.datatransfer.DataFlavor} associated with {@link TransferableObject} has the representation class <tt>net.iharder.dnd.TransferableObject.class</tt> and MIME type <tt>application/x-net.iharder.dnd.TransferableObject</tt>. This data
	...
	public static class TransferableObject implements java.awt.datatransfer.Transferable {
		 ...
		 * getTransferData(...)} method is called on the {@link TransferableObject}, the {@link Fetcher}'s {@link #getObject
		 ...
		 * that is returned by <var>fetcher</var>. Along with the {@link #DATA_FLAVOR} associated with this class, this creates a
		...
		/**
		 * Returns the custom {@link java.awt.datatransfer.DataFlavor} associated with the encapsulated object or <tt>null</tt> if the {@link Fetcher} constructor was used without passing a {@link java.lang.Class}.
		 *
		 ...
		 * the {@link Fetcher} constructor was used, then this is when the {@link Fetcher#getObject getObject()} method will be called. If the
		 * requested data flavor is not supported, then the {@link Fetcher#getObject getObject()} method will not be called.
		 *
		 * @param flavor
		 ...
		 * default {@link #DATA_FLAVOR} associated with {@link TransferableObject}, and third the {@link java.awt.datatransfer.DataFlavor.stringFlavor}.
		 *
	 ...
	 * @since 1.0
	 */
	public static boolean remove(final java.io.PrintStream out, final java.awt.Component c, final boolean recursive) { // Make
	 ...
	 * option to recursively set drop targets. If your component is a <tt>java.awt.Container</tt>, then each of its children components will
	 * also listen for drops, though only the parent will change borders. With
	 * Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
	 ...
	 * on. With Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
	 * parameter <tt>out</tt> will result in no debugging output.
	 *
	 * @param out
	 *            PrintStream to record debugging info or null for no debugging.
	 ...
	 * With Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
	 * parameter <tt>out</tt> will result in no debugging output.
	 *
	 * @param out
	 *            PrintStream to record debugging info or null for no debugging.
