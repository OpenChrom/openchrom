...
/**
 * TargetCalculationSelection allows the calculation of a target at which the data will be aligned
 *
 * @author Alexander Stark
 */
public enum IcoShiftAlignmentTargetCalculationSelection {
	/**
	 * select "MEAN" to calculate a mean target over all spectra from the selected dataset
	 *
	 * @param MEAN
	 */
	MEAN("Mean"), //
	/**
	 * select "MEDIAN" to calculate a median target over all spectra from the selected dataset
	 *
	 * @param MEDIAN
	 */
	MEDIAN("Median"), //
	/**
	 * select "MAX" to calculate a max target over all spectra from the selected dataset
	 * but only within each selected interval
	 *
	 * @param MAX
	 */
	MAX("Max");//
