...
public class PhaseShift extends AbstractScanProcessor implements IScanProcessor {
	...
	public IProcessingInfo process(IScanNMR scanNMR, IProcessorSettings processorSettings, IProgressMonitor monitor) {
		...
		IProcessingInfo processingInfo = validate(scanNMR, processorSettings, PhaseShiftSettings.class);
		if(!processingInfo.hasErrorMessages()) {
			PhaseShiftSettings settings = (PhaseShiftSettings)processorSettings;
