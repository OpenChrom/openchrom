...
public class StandardsReferencerFieldEditor extends AbstractFieldEditor {
	...
	private static final String FILTER_NAME = "Standards Referencer Template (*.txt)";
	private static final String FILE_NAME = "StandardsReferencerTemplate.txt";
	//
	private static final String CATEGORY = "Standards Referencer";
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(object instanceof AssignerReference) {
					List<AssignerReference> settingsEdit = new ArrayList<>();
