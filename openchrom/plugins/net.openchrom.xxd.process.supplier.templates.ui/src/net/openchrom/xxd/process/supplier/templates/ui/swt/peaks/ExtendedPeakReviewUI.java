...
public class ExtendedPeakReviewUI extends Composite implements IExtendedPartUI {
	...
	private void createMarkPeakButton(Composite parent) {
		...
		button.setImage(ApplicationImageFactory.getInstance().getImage(IApplicationImage.IMAGE_VALIDATE, IApplicationImageProvider.SIZE_16x16));
	...
	private void update(ReviewSetting reviewSetting) {
		...
		if(reviewSetting != null) {
			...
			textTarget.setBackground(isCompoundAvailable ? Colors.LIGHT_GREEN : Colors.LIGHT_YELLOW);
