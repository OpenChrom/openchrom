	...
	private Button createButtonAdd(Composite parent) {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				InputDialog dialog = new InputDialog(button.getShell(), DIALOG_TITLE, MESSAGE_ADD, PeakIntegratorListUtil.EXAMPLE_SINGLE, new PeakIntegratorInputValidator(settings));
