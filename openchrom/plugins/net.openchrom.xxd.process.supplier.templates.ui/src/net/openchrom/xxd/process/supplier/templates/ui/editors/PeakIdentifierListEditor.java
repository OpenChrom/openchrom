...
public class PeakIdentifierListEditor extends ListEditor {
	...
	//
	private static final String FILE_NAME = "PeakIdentifierItems.txt";
	private static final String FILTER_EXTENSION = "*.txt";
	private static final String FILTER_NAME = "Items (*.txt)";
	//
	private PeakIdentifierListUtil util = new PeakIdentifierListUtil();
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(list != null) {
					...
					fileDialog.setFilterPath(PreferenceSupplier.getPeakIdentifierListPathImport());
					String path = fileDialog.open();
					if(path != null) {
						PreferenceSupplier.setPeakIdentifierListPathImport(fileDialog.getFilterPath());
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(list != null) {
					...
					fileDialog.setFilterPath(PreferenceSupplier.getPeakIdentifierListPathExport());
					String path = fileDialog.open();
					if(path != null) {
						PreferenceSupplier.setPeakIdentifierListPathExport(fileDialog.getFilterPath());
						File file = new File(path);
