...
public class PagePeakTransfer extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new FloatFieldEditor(PreferenceSupplier.P_TRANSFER_MATCH_QUALITY, "Match Quality", PreferenceSupplier.MIN_FACTOR, PreferenceSupplier.MAX_FACTOR, getFieldEditorParent()));
