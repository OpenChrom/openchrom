...
import net.openchrom.xxd.process.supplier.templates.util.IListUtil;
...
public abstract class AbstractListEditor extends ListEditor {
	...
	public AbstractListEditor(String name, String labelText, Composite parent, IListUtil listUtil) {
	...
	protected String[] parseString(String stringList) {
		...
		String[] items = listUtil.parseString(stringList);
		Arrays.sort(items);
		return items;
	}

	protected String addItem(String item, List list) {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(list != null) {
					...
					if(path != null) {
						...
						java.util.List<String> items = listUtil.importItems(file);
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(list != null) {
					...
					if(path != null) {
						...
						File file = new File(path);
						String[] items = list.getItems();
						listUtil.exportItems(file, items);
					}
				}
			}
		});
