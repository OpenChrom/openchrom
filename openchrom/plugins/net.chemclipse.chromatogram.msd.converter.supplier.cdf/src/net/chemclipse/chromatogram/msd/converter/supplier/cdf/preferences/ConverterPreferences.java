 ...
 *******************************************************************************/
package net.chemclipse.chromatogram.msd.converter.supplier.cdf.preferences;
...
public class ConverterPreferences {
	...
	//
	private static final String PREFERENCE_NODE = "net.chemclipse.chromatogram.msd.converter.supplier.cdf.ui";
