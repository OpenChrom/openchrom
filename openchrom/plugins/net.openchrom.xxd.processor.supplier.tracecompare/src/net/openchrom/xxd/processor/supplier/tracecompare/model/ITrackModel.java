...
public interface ITrackModel {
	...
	String getPathSnapshotSample();

	void setPathSnapshotSample(String pathSnapshotSample);

	String getPathSnapshotReference();

	void setPathSnapshotReference(String pathSnapshotReference);
}