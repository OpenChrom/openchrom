 ...
 * of the Chemistry Development Kit. It is renamed to GeneralMassToFormulaTool allowing the
 * usage of additional isotopes (MassToFormulaTool allows only use of H,C,N,O).
 * See also the IsotopeDecider class.
 */
/*
...
public class GenericMassToFormulaTool {
	...
	public void setIsotopeDecider(IsotopeDecider isotopeDecider) {
		...
		this.isotopeDecider = isotopeDecider;
	}

	public GenericMassToFormulaTool(IChemObjectBuilder builder) {
	...
	private void callDefaultRestrictions() throws CDKException, IOException {
		...
		// isotopeDecider = new IsotopeDecider();
		isotopeDecider.addIsotopes(mfRange1);
	 ...
	 * 
	 * @param formula
	 *            The IMolecularFormula to put in order
	 ...
	 *            The mass to analyze
	 * @param formulaSet
	 *            The IMolecularFormulaSet to order
