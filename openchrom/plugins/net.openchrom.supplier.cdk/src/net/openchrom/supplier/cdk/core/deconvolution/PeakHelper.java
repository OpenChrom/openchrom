...
/**
 * Class that finds <em>basic properties of peaks</em>, e.g. their <em>start</em>,<em>end</em> and <em>max</em> properties, assuming that an m/z curve is given as an XYData<Double> instance.
 * 
