...
public class IsotopeDeciderFactory {
	...
	public IsotopeDecider getBasicSet()
	{
		...
		try {
			...
			isotopeSet.add(c12);isotopeSet.add(h1);isotopeSet.add(n14);isotopeSet.add(o16);
	...
	public IsotopeDecider getImportantOrganicIsotopes()
	{
		...
		try {
			...
			isotopeSet.add(c12);isotopeSet.add(h1);isotopeSet.add(n14);isotopeSet.add(o16);
			isotopeSet.add(cl);isotopeSet.add(br);isotopeSet.add(s);isotopeSet.add(p);
			isotopeSet.add(i); isotopeSet.add(b);
			isotopeDecider.setIsotopeSet(isotopeSet);
