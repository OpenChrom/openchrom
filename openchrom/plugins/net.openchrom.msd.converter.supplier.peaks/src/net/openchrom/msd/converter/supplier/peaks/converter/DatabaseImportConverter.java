...
import net.openchrom.msd.converter.supplier.peaks.converter.io.PeaksReader;

public class DatabaseImportConverter extends AbstractDatabaseImportConverter {

	private static final String DESCRIPTION = "Spectra Bank / SPECLUST .peaks Library Import";
	...
	public IProcessingInfo<IMassSpectra> convert(final File file, final IProgressMonitor monitor) {
		...
		if(!processingInfo.hasErrorMessages()) {
			try {
				final PeaksReader peaksReader = new PeaksReader();
