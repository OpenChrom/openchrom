...
public class NoMatchA2 implements ITestMassSpectrum {
	...
	public NoMatchA2() throws Exception {
		...
		massSpectrum.addIon(new DefaultIon(65.0d, 1017.0f));
		massSpectrum.addIon(new DefaultIon(70.0d, 202891.0f));
		massSpectrum.addIon(new DefaultIon(72.0d, 22.0f));
		massSpectrum.addIon(new DefaultIon(80.0d, 84.0f));
		massSpectrum.addIon(new DefaultIon(95.0d, 40.0f));
		massSpectrum.addIon(new DefaultIon(97.0d, 7.0f));
	}
