 ...
 *******************************************************************************/
package net.openchrom.chromatogram.xxd.report.supplier.pdf.ui.core;
...
import net.openchrom.chromatogram.xxd.report.supplier.pdf.ui.generator.ChromatogramReportWriter;
	...
	public IProcessingInfo<File> report(File file, boolean append, List<IChromatogram> chromatograms, IChromatogramReportSettings settings) {
		...
		if(!processingInfo.hasErrorMessages()) {
			if(settings instanceof ChromatogramReportSettings reportSettings) {
				try {
					ChromatogramReportWriter chromatogramReport = new ChromatogramReportWriter();
