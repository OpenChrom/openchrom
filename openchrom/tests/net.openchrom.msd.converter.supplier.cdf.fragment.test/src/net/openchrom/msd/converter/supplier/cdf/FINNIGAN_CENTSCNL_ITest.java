...
public class FINNIGAN_CENTSCNL_ITest {
	...
	public void setUp() throws IOException {
		...
		File file = PathResolver.getFile(FrameworkUtil.getBundle(getClass()), TestPathHelper.FINNIGAN_CENTSCNL);
	...
	public void testScans() {
		...
		assertEquals(2187, chromatogram.getNumberOfScanIons());
		assertEquals(100000, chromatogram.getScan(100).getRetentionTime());
	}
}
