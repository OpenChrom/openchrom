...
public class EXTREL_CENTSIDH_ITest {
	...
	public void setUp() throws IOException {
		...
		File file = PathResolver.getFile(FrameworkUtil.getBundle(getClass()), TestPathHelper.EXTREL_CENTSIDH);
	...
	public void testScans() {
		...
		assertEquals(39, chromatogram.getNumberOfScanIons());
		assertEquals(659707, chromatogram.getScan(9).getRetentionTime());
	}
}
