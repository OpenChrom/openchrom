...
public class KRATOS_CENTSCNH_ITest {
	...
	public void testImport() {
		...
		File file = new File("testData/KRATOS/CENTSCNH.CDF");
	...
	public void testDate() {
		...
		assertEquals(Instant.parse("1993-09-09T13:41:39Z"), chromatogram.getDate().toInstant());
	}
	...
	public void testScans() {
		...
		assertEquals(3274, chromatogram.getNumberOfScanIons());
