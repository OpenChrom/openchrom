...
public class FISONS_A_CENTSCNH_ITest {
	...
	public void setUp() throws IOException {
		...
		File file = PathResolver.getFile(FrameworkUtil.getBundle(getClass()), TestPathHelper.FISONS_A_CENTSCNH);
	...
	public void testScans() {
		...
		assertEquals(857, chromatogram.getNumberOfScanIons());
		assertEquals(6000, chromatogram.getScan(5).getRetentionTime());
	}
}
