...
public class PCB_ITest {
	...
	public void testImport() {
		...
		file = new File("testData/PCB.CDF");
	...
	public void testDate() {
		...
		assertEquals(Instant.parse("1986-04-02T01:45:00Z"), chromatogram.getDate().toInstant());
	}
	...
	public void testScans() {
		...
		assertEquals(5116.0f, chromatogram.getScan(3200).getTotalSignal(), 0);
