...
public class DNX_7AN_ITest {
	...
	public void testImport() {
		...
		File file = new File("testData/Dionex/DNX-7AN.CDF");
	...
	public void testDate() {
		...
		assertEquals(Instant.parse("1996-07-24T02:12:07Z"), chromatogram.getDate().toInstant());
	}

	@Test
	public void testOperator() {

		assertEquals("none", chromatogram.getOperator());
	}

	@Test
	public void testScans() {

		assertEquals(2405, chromatogram.getNumberOfScans());
		assertEquals(2.497f, chromatogram.getScan(1000).getTotalSignal(), 0);
		assertEquals(480800, chromatogram.getScan(2405).getRetentionTime());
	}
}
