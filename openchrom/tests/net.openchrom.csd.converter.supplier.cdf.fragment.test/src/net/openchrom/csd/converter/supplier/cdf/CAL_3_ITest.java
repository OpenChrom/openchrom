...
public class CAL_3_ITest {
	...
	public void testImport() {
		...
		file = new File("testData/CAL_3.CDF");
	...
	public void testDate() {
		...
		assertEquals(Instant.parse("1992-12-25T11:58:47Z"), chromatogram.getDate().toInstant());
	}

	@Test
	public void testOperator() {

		assertEquals("A. Chemist", chromatogram.getOperator());
	}

	@Test
	public void testScans() {

		assertEquals(4501, chromatogram.getNumberOfScans());
		assertEquals(0.006377f, chromatogram.getScan(2250).getTotalSignal(), 0);
		assertEquals(900000, chromatogram.getScan(4501).getRetentionTime());
	}
}
