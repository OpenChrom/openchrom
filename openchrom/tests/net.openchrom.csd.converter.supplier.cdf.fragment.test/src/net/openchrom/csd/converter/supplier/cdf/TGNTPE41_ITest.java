...
public class TGNTPE41_ITest {
	...
	public void setUp() {
		...
		File file = new File("testData/Thru-Put Systems/tgntpe41.cdf");
	...
	public void testDate() {
		...
		assertEquals(Instant.parse("1997-01-28T19:54:49Z"), chromatogram.getDate().toInstant());
	}

	@Test
	public void testOperator() {

		assertEquals("JDJ", chromatogram.getOperator());
	}
