...
public class DIONEX_ITest {
	...
	public void setUp() throws IOException {
		...
		File file = PathResolver.getFile(FrameworkUtil.getBundle(getClass()), TestPathHelper.DIONEX);
	...
	public void testScans() {
		...
		assertEquals(2.497024f, chromatogram.getScan(1000).getTotalSignal(), 0);
