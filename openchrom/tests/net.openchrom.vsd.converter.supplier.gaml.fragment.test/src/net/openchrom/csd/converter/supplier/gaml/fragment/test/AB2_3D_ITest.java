...
public class AB2_3D_ITest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		super.setUp();
		File file = new File(PathResolver.getAbsolutePath(TestPathHelper.TS_AB2_3D));
	...
	public void testSignals() {
		...
		assertEquals(201, vendorSpectrum.getScanVSD().getProcessedSignals().size());
	}
}
