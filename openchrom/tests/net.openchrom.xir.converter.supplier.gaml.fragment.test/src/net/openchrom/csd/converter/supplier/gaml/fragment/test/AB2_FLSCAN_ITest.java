...
public class AB2_FLSCAN_ITest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		super.setUp();
		File file = new File(PathResolver.getAbsolutePath(TestPathHelper.TS_AB2_FLSCAN));
	...
	public void testSignals() {
		...
		assertEquals(301, vendorSpectrum.getScanISD().getProcessedSignals().size());
	}
}
