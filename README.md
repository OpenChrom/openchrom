...
[OpenChrom®](https://en.wikipedia.org/wiki/OpenChrom) is a tool for the analysis and visualization of mass spectrometric and chromatographic data developed by [Lablicate GmbH](https://lablicate.com). ![lablicate-logo](https://lablicate.com/img/LablicateLogo.png | width=100)
