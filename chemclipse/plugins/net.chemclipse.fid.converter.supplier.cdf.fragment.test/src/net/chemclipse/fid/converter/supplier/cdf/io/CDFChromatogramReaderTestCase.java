...
import net.chemclipse.fid.converter.chromatogram.ChromatogramConverterFID;
...
public class CDFChromatogramReaderTestCase extends TestCase {
	...
	private final static String EXTENSION_POINT_ID = "net.chemclipse.fid.converter.supplier.cdf";
