...
import net.openchrom.chromatogram.msd.identifier.supplier.cdk.ui.internal.handlers.DeleteIdentificationsRunnable;

public class DeleteIdentificationsHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(DeleteIdentificationsHandler.class);
	...
	public void execute() {
		...
		if(chromatogramSelection != null) {
			...
			if(SWT.YES == decision) {
				...
				IRunnableWithProgress runnable = new DeleteIdentificationsRunnable(chromatogramSelection);
