...
import net.openchrom.chromatogram.msd.identifier.supplier.cdk.ui.internal.handlers.DeleteIdentificationsWithoutSmilesRunnable;

public class DeleteIdentificationsWithoutSMILESHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(DeleteIdentificationsWithoutSMILESHandler.class);
	...
	public void execute() {
		...
		if(chromatogramSelection != null) {
			...
			if(SWT.YES == decision) {
				...
				IRunnableWithProgress runnable = new DeleteIdentificationsWithoutSmilesRunnable(chromatogramSelection);
